      ...
      <nav className="relative px-4 py-4 flex justify-between items-center bg-slate-900">
        <div className="lg:hidden">
          <button className="navbar-burger flex items-center text-blue-600 p-3" onClick={() => {
                  hideNav === "hidden" ? setHideNav("") : setHideNav("hidden");
                }}>
            <svg
        ...
        <nav className="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-slate-700 border-r overflow-y-auto navbar-edit">
          ...
          <div>
            <ul>
              <li className="mb-1">
                <a
                  className="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-600 hover:text-white rounded transition-colors duration-200 ease-in-out"
                  href="/"
                >
                  Home
                </a>
